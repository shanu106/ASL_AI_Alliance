...
finger_curl_angles = {
    'thumb': {
        'base': (49.3723, -15.127, 0.704966),
        'mid': (0.0, 0.0, 0.0),
        'tip': (0.0, 0.0, 0.0)
    },
    'index': {
        'base': (-15.1311, 29.1775, 26.3335),
        'mid': (0.0, 0.0, 0.0),
        'tip': (0.0, 0.0, 0.0)
    },
    'middle': {
        'base': (-37.5542, 3.39035, 153.059),
        'mid': (0.0, 0.0, 0.0),
        'tip': (0.0, 0.0, 0.0)
    },
    'ring': {
        'base': (-37.4751, 2.90254, 151.652),
        'mid': (0.0, 0.0, 0.0),
        'tip': (0.0, 0.0, 0.0)
    },
    'pinky': {
        'base': (-36.2297, -1.3674, 138.931),
        'mid': (0.0, 0.0, 0.0),
        'tip': (0.0, 0.0, 0.0)
    }
}
...
wrist.rotation_euler=(math.radians(59.503),math.radians(-65.978),math.radians(16.909))
