...
finger_curl_angles = {
    'thumb': {
        'base': (82.0373, -8.48747, 9.18827),
        'mid': (2.19678, -7.24187 , 6.89457),
        'tip': (2.35468, -7.91454, 7.51446)
    },
    'index': {
        'base': (63.7221, -19.3383, 52.5706),
        'mid': (7.22489, 4.22556, 2.95466),
        'tip': (12.5349, 22.0961, 27.2148)
    },
    'middle': {
        'base': (-107.021, -9.75302, 118.812),
        'mid': (-73.1548, -55.5962, 13.9512),
        'tip': (0.0, 0.0, 0.0)
    },
    'ring': {
        'base': (-132.188,6.84, 140.549),
        'mid': (0-5.77895, -23.4358, 8.08491),
        'tip': (0.0, 0.0, 0.0)
    },
    'pinky': {
        'base': (-11.4634, 64.3343, 153.605),
        'mid': (0.0, 0.0, 0.0),
        'tip': (0.0, 0.0, 0.0)
    }
}
