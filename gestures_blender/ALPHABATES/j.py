...
finger_curl_angles = {
    'thumb': {
        'base': (65.9738, -8.37101, -18.7032),
        'mid': (0.0, 0.0, 0.0),
        'tip': (0.0, 0.0, 0.0)
    },
    'index': {
        'base': (-62.0086, -22.3412, 110.542),
        'mid': (-55.409, -34.0149, 103.346),
        'tip': (-0.643726, 17.7135, -20.3422)
    },
    'middle': {
        'base': (-42.3553, -20.4881, 89.6728),
        'mid': (-50.4381, 5.02566, 99.2657),
        'tip': (126.081, -39.7415, -110.583)
    },
    'ring': {
        'base': (-26.4817, 1.68121, 90.6303),
        'mid': (-43.3142, 10.9317, 105.628),
        'tip': (0.0, 0.0, 0.0)
    },
    'pinky': {
        'base': (-71.3143,-5.36596, 53.2902),
        'mid': (0.0, 0.0, 0.0),
        'tip': (0.0, 0.0, 0.0)
    }
}
