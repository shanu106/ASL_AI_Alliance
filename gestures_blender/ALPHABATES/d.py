...
finger_curl_angles = {
    'thumb': {
        'base': (61.7434, -26.5921, 22.7153),   # Thumb1
        'mid': (0.0, 0.0, 0.0),                 # Thumb2
        'tip': (39.6855, -60.2535, 1.86712)     # Thumb3
    },
    'index': {
        'base': (0.0, 0.0, 0.0),                # Index1
        'mid': (0.0, 0.0, 0.0),                 # Index2
        'tip': (0.0, 0.0, 0.0)                  # Index3
    },
    'middle': {
        'base': (-8.72446, 11.3427, 96.8019),   # Middle1
        'mid': (0.0, 0.0, 0.0),                 # Middle2
        'tip': (-5.01136, 12.8522, 91.7701)     # Middle3
    },
    'ring': {
        'base': (-14.7772, 20.4952, 78.9538),   # Ring1
        'mid': (-1.08971, 6.2549, 8.45538),     # Ring2
        'tip': (-13.1092, 26.7673, 98.7031)     # Ring3
    },
    'pinky': {
        'base': (-44.4083, 49.2687, 58.0658),   # Pinky1
        'mid': (0,0,0),    # Pinky2
        'tip': (-66.8208,17.6679,50.0315)     # Pinky3
    }
}
