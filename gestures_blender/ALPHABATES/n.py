...
finger_curl_angles = {
    'thumb': {
        'base': (56.5472, -16.9418, -36.5257),
        'mid': (27.3587, -37.3308, 20.7478),
        'tip': (0.0, 0.0, 0.0)
    },
    'index': {
        'base': (2.90642, -10.9165, 53.0231),
        'mid': (15.1366, -15.1208, 101.811),
        'tip': (-1.57819, 0.108324, 57.0373)
    },
    'middle': {
        'base': (22.0269, 11.3386,64.485),
        'mid': (59.0636, 24.0989, 130.725),
        'tip': (0.0, 0.0, 0.0)
    },
    'ring': {
