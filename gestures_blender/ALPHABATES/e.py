...
finger_curl_angles = {
    ...
    'index': {
        'base': (13.3796, -33.363, 93.0849),
        'mid': (0.0, 0.0, 0.0),
        'tip': (46.2772, -6.78562, 125.857)
    },
    'middle': {
        'base': (-10.0064, -5.29719, 98.0655),
        'mid': (0.0, 0.0, 0.0),
        'tip': (53.524, -6.51552, 100.332)
    },
    'ring': {
        'base': (12.365, 5.1389, 92.9746),
        'mid': (0.0, 0.0, 0.0),
        'tip': (88.3847, 33.3951, 107.752)
    },
    'pinky': {
        'base': (0.0, 38, 76),
        'mid': (0.0, 0.0, 0.0),
        'tip': (-94.3119, 43.0839, 52.9126)
    }
}
