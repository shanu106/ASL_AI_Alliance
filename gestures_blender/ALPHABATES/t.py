...
finger_curl_angles = {
    'thumb': {
        'base': (65.5138, -26.3372, -39.9809),
        'mid': (0,0,0),
        'tip': (24.4809, -10.4592, 16.2175)
    },
    'index': {
        'base': (-2.22402, 0.882137, 92.4512),
        'mid': (-1.2321, -13.1901, 97.3745),
        'tip': (-1.57819, 0.108324, 57.0373)
    },
    'middle': {
        'base': (21.436, 12.8521,122.907),
        'mid': (38.5889, 19.5612, 82.0438),
        'tip': (0.0, 0.0, 0.0)
    },
    'ring': {
        'base': (6.54277, 33.6668, 105.215),
        'mid': (-30.6716, 24.6452, 97.089),
        'tip': (0.0, 0.0, 0.0)
    },
    'pinky': {
        'base': (-43.6221, 35.7098, 20.6038),
        'mid': (-109.657, 1.13711, 96.2876),
        'tip': (0.0, 0.0, 0.0)
    }
}
