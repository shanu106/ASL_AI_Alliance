...
finger_curl_angles = {
    'thumb': {
        'base': (-1.68868, -72.9878, 7.15596),
        'mid': (-14.4615, -50.8268, 20.7718),
        'tip': (0.0, 0.0, 0.0)
    },
    'index': {
        'base': (6.1238, 21.9952, 53.297),
        'mid': (0.0, 0.0, 0.0),
        'tip': (0.0, 0.0, 0.0)
    },
    'middle': {
        'base': (40.4982, 34.647, 129.683),
        'mid': (0.18445, 0.440801, -0.320789),
        'tip': (0.0, 0.0, 0.0)
    },
    'ring': {
        'base': (60.1241, 56.774, 160.327),
        'mid': (-7.72775, 10.7441, 12.8785),
        'tip': (0.0, 0.0, 0.0)
    },
    'pinky': {
        'base': (128.121, 57.0658, 222.845),
        'mid': (-34.12, 27.528, 1.01759),
        'tip': (0.0, 0.0, 0.0)
    }
}
...
wrist.rotation_euler=(math.radians(-1.68868),math.radians(-72.9878),math.radians(7.15596))
