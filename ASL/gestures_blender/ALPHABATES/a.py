...
finger_curl_angles = {
    'thumb': {
        'base': (6.10492, -34.6721, 5.86819),
        'mid': (0.0, 0.0, 0.0),
        'tip': (0.0, 0.0, 0.0)
    },
    'index': {
        'base': (1.65664, 5.44198, 108.285),
        'mid': (11.1716, 15.6621, 82.3013),
        'tip': (0.000096, 0.003327, 0.010794)
    },
    'middle': {
        'base': (-1.60562, 23.8552, 119.699),
        'mid': (-10.1918, 21.09, 60.8682),
        'tip': (-0.000893, 0.00422, 0.016718)
    },
    'ring': {
        'base': (-6.12772, 47.0242, 105.8),
        'mid': (58.4695, 6.2549, 75.5722),
        'tip': (-0.003003, 0.002272, 0.011443)
    },
    'pinky': {
        'base': (-93.7655, 51.8927, 23.7499),
        'mid': (-12.5325, 19.9545, 100.178),
        'tip': (-0.019559, 0.000812, 0.02313)
    }
}
