...
finger_curl_angles = {
    'thumb': {
        'base': (21.9553, -45.214, -6.53743),
        'mid': (3.79943, -9.57603, 0.212498),
        'tip': (38.4823, -60.0024, -18.8903)
    },
    'index': {
        'base': (3.44517, -8.68777, 0.219634),
        'mid': (1.55407, -2.9184, 0.163674),
        'tip': (0.0, 0.0, 0.0)
    },
    'middle': {
        'base': (-2.37829, 5.90165, -0.450062),
        'mid': (0.0, 0.0, 0.0),
        'tip': (0.0, 0.0, 0.0)
    },
    'ring': {
        'base': (-14.6591, 47.4359, 154.089),
        'mid': (14.357, 11.9306, 12.3582),
        'tip': (0.0, 0.0, 0.0)
    },
    'pinky': {
        'base': (69.0611, 71.7758, 192.988),
        'mid': (-25.3766, 15.8825, 2.66438),
        'tip': (0.0, 0.0, 0.0)
    }
}
