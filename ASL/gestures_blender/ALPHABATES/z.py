...
finger_curl_angles = {
    ...
    'middle': {
        'base': (-2.34489, 1.57308, 116.892),
        'mid': (-12.3664, 18.0164, 84.6606),
        'tip': (0.0, 0.0, 0.0)
    },
    'ring': {
        'base': (1.90592, 21.3619, 105.24),
        'mid': (-20.6206, 37.1742, 86.0086),
        'tip': (0.0, 0.0, 0.0)
    },
    'pinky': {
        'base': (-0.819797, 60.0067, 83.1062),
        'mid': (-72.5735, 25.2157, 32.1878),
        'tip': (-37.1184, 7.70172, 20.0224)
    }
}
