...
finger_curl_angles = {
    'thumb': {
        'base': (90.4804, -46.6041, -27.8955),
        'mid': (0.0, 0.0, 0.0),
        'tip': (-4.50199, -4.40548, 0.06572)
    },
    'index': {
        'base': (0.448225, -7.39007, -0.106397),
        'mid': (0.0, 0.0, 0.0),
        'tip': (0.0, 0.0, 0.0)
    },
    'middle': {
        'base': (-0.574345, 9.68319, 0.052926),
        'mid': (0.0, 0.0, 0.0),
        'tip': (0.0, 0.0, 0.0)
    },
    'ring': {
        'base': (6.65932, 32.3161, 92.6544),
        'mid': (-30.6716,24.6452, 97.089),
        'tip': (0.0, 0.0, 0.0)
    },
    'pinky': {
        'base': (-44.1649, 35.7368, 35.6016),
